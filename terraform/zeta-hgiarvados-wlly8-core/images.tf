...
module "hgi-openstack-image-hgi-arvados_compute-xenial-4cb02ffa" {
  source     = "../modules/hgi-openstack-image"
  env        = "${var.env}"
  region     = "${var.region}"
  setup      = "${var.setup}"
  image_name = "hgi-arvados_compute-xenial-4cb02ffa"
  image_user = "ubuntu"
}

output "hgi-openstack-image-hgi-arvados_compute-xenial-4cb02ffa" {
  value = "${module.hgi-openstack-image-hgi-arvados_compute-xenial-4cb02ffa.image}"
}
