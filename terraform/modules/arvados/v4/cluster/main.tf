...
variable "irobot_count" {
  default = 0
}

variable "irobot_flavour" {
  default = "o1.medium"
}

variable "irobot_volume_size_gb" {
  default = 250
}
...
module "arvados-irobot" {
  ...
  volume_size_gb = "${var.irobot_volume_size_gb}"
}

output "hgi_instances" {
  value = {
    external_dns    = "${merge(module.arvados-master.hgi_instance["external_dns"], module.arvados-api-db.hgi_instance["external_dns"], module.arvados-sso.hgi_instance["external_dns"], module.arvados-workbench.hgi_instance["external_dns"], module.arvados-keepproxy.hgi_instance["external_dns"], module.arvados-shell.hgi_instance["external_dns"], module.arvados-monitor.hgi_instance["external_dns"])}"
    floating_ip     = "${merge(module.arvados-master.hgi_instance["floating_ip"], module.arvados-api-db.hgi_instance["floating_ip"], module.arvados-sso.hgi_instance["floating_ip"], module.arvados-workbench.hgi_instance["floating_ip"], module.arvados-keepproxy.hgi_instance["floating_ip"], module.arvados-shell.hgi_instance["floating_ip"], module.arvados-monitor.hgi_instance["floating_ip"])}"
    internal_ip     = "${merge(module.arvados-master.hgi_instance["internal_ip"], module.arvados-api-db.hgi_instance["internal_ip"], module.arvados-sso.hgi_instance["internal_ip"], module.arvados-workbench.hgi_instance["internal_ip"], module.arvados-keepproxy.hgi_instance["internal_ip"], module.arvados-shell.hgi_instance["internal_ip"], module.arvados-monitor.hgi_instance["internal_ip"])}"
    user            = "${merge(module.arvados-master.hgi_instance["user"], module.arvados-api-db.hgi_instance["user"], module.arvados-sso.hgi_instance["user"], module.arvados-workbench.hgi_instance["user"], module.arvados-keepproxy.hgi_instance["user"], module.arvados-shell.hgi_instance["user"], module.arvados-monitor.hgi_instance["user"])}"
    security_groups = "${merge(module.arvados-master.hgi_instance["security_groups"], module.arvados-api-db.hgi_instance["security_groups"], module.arvados-sso.hgi_instance["security_groups"], module.arvados-workbench.hgi_instance["security_groups"], module.arvados-keepproxy.hgi_instance["security_groups"], module.arvados-shell.hgi_instance["security_groups"], module.arvados-monitor.hgi_instance["security_groups"])}"
  }
}
...
output "hgi_instances_by_type" {
  value = {
    ...
    arvados-irobot      = "${module.arvados-irobot.hgi_instances}"
  }
}
